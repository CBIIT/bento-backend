module "alb" {
  source = "https://github.com/CBIIT/datacommons-devops/tree/main/terraform/modules/loadbalancer"
  vpc_id = var.vpc_id
...
module "s3" {
  source = "https://github.com/CBIIT/datacommons-devops/tree/main/terraform/modules/s3"
