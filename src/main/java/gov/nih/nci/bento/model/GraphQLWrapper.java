...
public class GraphQLWrapper {
    ...
    public GraphQLWrapper(String input, List<String> listOfServiceQueries){
        ...
        OperationDefinition request = (OperationDefinition) queryDoc.getDefinitions().get(0);
        ...
        for (Field query: queries){
            ...
            if (listOfServiceQueries != null && listOfServiceQueries.contains(name)){
    ...
    private String appendSelections(String graphQLInput, List<Selection> selections){
        String graphQL = graphQLInput + "{";
