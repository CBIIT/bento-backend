...
public class TypeMapperImplTest {
    ...
    public TypeMapperTest<List<Map<String, Object>>> getDefault(Set<String> returnTypes) {
        return (response) -> getMaps(response, returnTypes);
    }


    public TypeMapperTest<QueryResult> getDefaultReturnTypes(Set<String> returnTypes) {
    ...
    public TypeMapperTest<List<Map<String, Object>>> getICDCAggregate() {
        return (response) -> {
    ...
    public TypeMapperTest<List<Map<String, Object>>> getAggregate() {
        return (response) -> {
            List<Map<String, Object>> result = new ArrayList<>();
            Aggregations aggregate = response.getAggregations();
            Terms terms = aggregate.get(ES_PARAMS.TERMS_AGGS);
    ...
    public TypeMapperTest<List<String>> getStrList(String field) {
    ...
    public TypeMapperTest<Long> getIntTotal() {
        return (response) -> {
    ...
    public TypeMapperTest<Map<String, Object>> getRange() {
        return (response) -> {
            Aggregations aggregate = response.getAggregations();
    ...
    public TypeMapperTest<List<Map<String, Object>>> getAboutPage() {
        return (response) -> {
            List<Map<String, Object>> result = new ArrayList<>();
            SearchHit[] hits = response.getHits().getHits();
            Arrays.asList(hits).forEach(hit-> {
    ...
    public TypeMapperTest<QueryResult> getHighLightFragments(String field, HighLightMapper mapper) {
        return (response) -> {
            List<Map<String, Object>> result = new ArrayList<>();
            SearchHit[] hits = response.getHits().getHits();
            Arrays.asList(hits).forEach(hit-> {
    ...
    public TypeMapperTest<QueryResult> getMapWithHighlightedFields(Set<String> returnTypes) {
        return (response) -> {
            List<Map<String, Object>> result = new ArrayList<>();
            SearchHit[] hits = response.getHits().getHits();
            Arrays.asList(hits).forEach(hit-> {
    ...
    @SuppressWarnings("unchecked")
    public TypeMapperTest<List<Map<String, Object>>> getArmProgram() {
