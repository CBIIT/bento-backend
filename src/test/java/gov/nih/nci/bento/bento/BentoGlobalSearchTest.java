...
public class BentoGlobalSearchTest {
    ...
    public void searchGlobalSample_Test() throws IOException {
        // Set Bool Filter
        BoolQueryBuilder bool = new BoolQueryBuilder()
                .should(QueryBuilders.termsQuery(Const.BENTO_FIELDS.SAMPLE_ID_GS, List.of(_sampleId)));
//        bool.should(QueryBuilders.termsQuery(BENTO_FIELDS.SAMPLE_ANATOMIC_SITE_GS, List.of(_sampleAnatomicSite)));
//        bool.should(QueryBuilders.termsQuery(BENTO_FIELDS.TISSUE_TYPE_GS, List.of(_tissueType)));
        // Set Builder
        SearchSourceBuilder builder = new SearchSourceBuilder();
        builder.query(bool);
        // Set Request
        SearchRequest request = new SearchRequest();
        request.indices(Const.BENTO_INDEX.SAMPLES);
        request.source(builder);

        // TODO
        // Mis-Field Name Match
        Map<String, String> returnTypes = new HashMap<>();
        returnTypes.put(Const.BENTO_FIELDS.PROGRAM_ID, Const.BENTO_FIELDS.PROGRAM_ID);
    ...
    @Test
    public void searchGlobalStudies_Test() throws IOException {
        // Set Bool Filter
        BoolQueryBuilder bool = new BoolQueryBuilder()
